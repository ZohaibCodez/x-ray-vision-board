...
import { Loader2, Salad, Sparkles, Lightbulb } from "lucide-react";
      ...
      <div className="mx-auto max-w-4xl">
        {!plan ? (
          <>
            ...
            <div className="rounded-2xl border border-border bg-card p-6 space-y-6" style={{ background: "var(--gradient-card)" }}>
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-md border border-border bg-background/60 px-4 py-3 text-sm placeholder:text-muted-foreground focus:border-primary focus:outline-none"
                />
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="flex h-14 w-full items-center justify-center gap-2 rounded-xl bg-primary text-base font-semibold text-primary-foreground transition-all hover:shadow-[var(--glow-cyan)] disabled:opacity-50"
              >
          ...
          <>
            ...
            <div className="space-y-4">
              {plan.plan.map((day) => (
                <div key={day.day} className="rounded-xl border border-border bg-card p-5" style={{ background: "var(--gradient-card)" }}>
                  <h3 className="font-display text-lg font-bold text-primary">{day.day}</h3>
                  <div className="mt-4 grid gap-3 sm:grid-cols-3">
                    <MealCard title="🌅 Breakfast" meal={day.breakfast} />
                    <MealCard title="☀️ Lunch" meal={day.lunch} />
