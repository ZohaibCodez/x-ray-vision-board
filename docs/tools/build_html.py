...
FILES = ["README.md", "01-SRS.md", "02-SDD.md", "03-Test-Cases.md", "04-User-Manual.md", "05-Thesis.md"]
...
@media print{
  ...
  table,pre,.mermaid-figure,img{page-break-inside:avoid}
}
"""

NAV = ('<div class="docnav"><strong>XRayVision AI docs:</strong> '
       '<a href="README.html">Index</a><a href="01-SRS.html">SRS</a>'
